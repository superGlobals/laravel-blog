            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="mb-2" style="max-width: 200px">
                  <img src="" class="img-thumbnail" id="logo-image-preview" alt="" data-ijabo-default-img="{{ \App\Models\Setting::find(1)->blog_logo }}">
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="mb-2" style="max-width: 100px">
                  <img src="" class="img-thumbnail" id="favicon-image-preview" alt="" data-ijabo-default-img="{{ \App\Models\Setting::find(1)->blog_favicon }}">
                </div>
