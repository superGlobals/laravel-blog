          ...
          <article class="card article-card">
            <a href="article.html">
              <div class="card-image">
                ...
                <img loading="lazy" decoding="async" src="{{ asset('front/images/post/post-1.jpg') }}" alt="Post Thumbnail" class="w-100">
              </div>
            </a>
          ...
          <article class="card article-card article-card-sm h-100">
            <a href="article.html">
              <div class="card-image">
                ...
                <img loading="lazy" decoding="async" src="{{ asset('front/images/post/post-2.jpg') }}" alt="Post Thumbnail" class="w-100">
              </div>
            </a>
          ...
          <article class="card article-card article-card-sm h-100">
            <a href="article.html">
              <div class="card-image">
                ...
                <img loading="lazy" decoding="async" src="{{ asset('front/images/post/ls-2.jpg') }}" alt="Post Thumbnail" class="w-100">
              </div>
            </a>
            <div class="card-body px-0 pb-0">
              <ul class="post-meta mb-2">
          ...
          <article class="card article-card article-card-sm h-100">
            <a href="article.html">
              <div class="card-image">
                ...
                <img loading="lazy" decoding="async" src="{{ asset('front/images/post/cr-1.jpg') }}" alt="Post Thumbnail" class="w-100">
              </div>
            </a>
            <div class="card-body px-0 pb-0">
              <ul class="post-meta mb-2">
          ...
          <article class="card article-card article-card-sm h-100">
            <a href="article.html">
              <div class="card-image">
                ...
                <img loading="lazy" decoding="async" src="{{ asset('front/images/post/cr-2.jpg') }}" alt="Post Thumbnail" class="w-100">
              </div>
            </a>
            <div class="card-body px-0 pb-0">
              <ul class="post-meta mb-2">
          ...
          <article class="card article-card article-card-sm h-100">
            <a href="article.html">
              <div class="card-image">
                ...
                <img loading="lazy" decoding="async" src="{{ asset('front/images/post/post-4.jpg') }}" alt="Post Thumbnail" class="w-100">
              </div>
            </a>
            <div class="card-body px-0 pb-0">
              <ul class="post-meta mb-2">
          ...
          <article class="card article-card article-card-sm h-100">
            <a href="article.html">
              <div class="card-image">
                ...
                <img loading="lazy" decoding="async" src="{{ asset('front/images/post/post-8.jpg') }}" alt="Post Thumbnail" class="w-100">
              </div>
            </a>
            <div class="card-body px-0 pb-0">
              <ul class="post-meta mb-2">
    ...
    <div class="widget">
      ...
      <div class="widget-body">
        <div class="widget-list">
          ...
          <a class="media align-items-center" href="article.html">
            <img loading="lazy" decoding="async" src="{{ asset('front/images/post/post-5.jpg') }}" alt="Post Thumbnail" class="w-100">
            <div class="media-body ml-3">
