                    ...
                    <article class="card article-card">
                        <a href="article.html">
                            <div class="card-image">
                                ...
                                <img loading="lazy" decoding="async" src="{{ asset('front/images/post/post-1.jpg') }}"
                        ...
                        <div class="card-body px-0 pb-1">
                            ...
                            <p class="card-text">Heading Here is example of hedings. You can use this heading by following
                    ...
                    <article class="card article-card article-card-sm h-100">
                        <a href="article.html">
                            <div class="card-image">
                                ...
                                <img loading="lazy" decoding="async" src="{{ asset('front/images/post/post-2.jpg') }}"
                                    alt="Post Thumbnail" class="w-100">
                            </div>
                        </a>
                    ...
                    <article class="card article-card article-card-sm h-100">
                        <a href="article.html">
                            <div class="card-image">
                                ...
                                <img loading="lazy" decoding="async" src="{{ asset('front/images/post/ls-2.jpg') }}"
                                    alt="Post Thumbnail" class="w-100">
                            </div>
                        </a>
                        <div class="card-body px-0 pb-0">
                    ...
                    <article class="card article-card article-card-sm h-100">
                        <a href="article.html">
                            <div class="card-image">
                                ...
                                <img loading="lazy" decoding="async" src="{{ asset('front/images/post/cr-1.jpg') }}"
                                    alt="Post Thumbnail" class="w-100">
                            </div>
                        </a>
                        <div class="card-body px-0 pb-0">
                    ...
                    <article class="card article-card article-card-sm h-100">
                        <a href="article.html">
                            <div class="card-image">
                                ...
                                <img loading="lazy" decoding="async" src="{{ asset('front/images/post/cr-2.jpg') }}"
                                    alt="Post Thumbnail" class="w-100">
                            </div>
                        </a>
                        <div class="card-body px-0 pb-0">
                    ...
                    <article class="card article-card article-card-sm h-100">
                        <a href="article.html">
                            <div class="card-image">
                                ...
                                <img loading="lazy" decoding="async" src="{{ asset('front/images/post/post-4.jpg') }}"
                                    alt="Post Thumbnail" class="w-100">
                            </div>
                        </a>
                        <div class="card-body px-0 pb-0">
                    ...
                    <article class="card article-card article-card-sm h-100">
                        <a href="article.html">
                            <div class="card-image">
                                ...
                                <img loading="lazy" decoding="async" src="{{ asset('front/images/post/post-8.jpg') }}"
                                    alt="Post Thumbnail" class="w-100">
                            </div>
                        </a>
                        <div class="card-body px-0 pb-0">
                    ...
                    <div class="col-lg-12">
                        <div class="widget">
                            <div class="widget-body">
                                <img loading="lazy" decoding="async" src="{{ asset('front/images/author.jpg') }}"
                            ...
                            <div class="widget-body">
                                <div class="widget-list">
                                    <article class="card mb-4">
                                        <div class="card-image">
                                            ...
                                            <img loading="lazy" decoding="async"
                                                src="{{ asset('front/images/post/post-9.jpg') }}" alt="Post Thumbnail"
                                                class="w-100">
                                        </div>
                                        <div class="card-body px-0 pb-1">
                                    ...
                                    <a class="media align-items-center" href="article.html">
                                        <img loading="lazy" decoding="async"
                                            src="{{ asset('front/images/post/post-2.jpg') }}" alt="Post Thumbnail"
                                            class="w-100">
                                    ...
                                    <a class="media align-items-center" href="article.html">
                                        <img loading="lazy" decoding="async"
                                            src="{{ asset('front/images/post/post-5.jpg') }}" alt="Post Thumbnail"
                                            class="w-100">
                                        <div class="media-body ml-3">
