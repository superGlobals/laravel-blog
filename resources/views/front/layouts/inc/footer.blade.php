<footer class="bg-dark mt-5">
      ...
      <div class="row">
        <div class="col-lg-10 mx-auto text-center">
          <a class="d-inline-block mb-4 pb-2" href="index.html">
            <img loading="prelaod" decoding="async" class="img-fluid" src="{{ asset('front/images/logo-white.png') }}" alt="Reporter Hugo">
          </a>
    ...
    <div class="copyright bg-dark content">Designed &amp; Developed By <a href="https://themefisher.com/">{{ blogInfo()->blog_name }}</a></div>
  </footer>